...
public class JugadorNoParticipaEnPartidoException extends TorneoException {
     ...
     */
    public JugadorNoParticipaEnPartidoException() {
        super("El jugador no participa en este partido, no se puede registrar el evento.");
    }
    ...
    public JugadorNoParticipaEnPartidoException(String nombreJugador) {
        super("El jugador '" + nombreJugador + "' no participa en este partido, no se puede registrar el evento.");
    }
}