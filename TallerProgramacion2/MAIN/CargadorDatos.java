...
public class CargadorDatos {
    ...
    public static Mundial cargar() {
        ...
        Pais mexico    = new Pais("Mexico",    "mex", null);
        Pais portugal  = new Pais("Portugal",  "por", null);
        Pais italia    = new Pais("Italia",    "ita", null);
        Pais inglaterra = new Pais("Inglaterra", "eng", null);
        Pais holanda   = new Pais("Holanda",   "ned", null);
        Pais croatia   = new Pais("Croacia",   "cro", null);
        Pais senegal   = new Pais("Senegal",   "sen", null);
        Pais japon     = new Pais("Japon",     "jpn", null);
        Pais marruecos = new Pais("Marruecos", "mar", null);
        ...
        Pais[] paisesConSede = {argentina, brasil, uruguay, colombia, francia, alemania,
                                 espania, mexico, portugal, italia, inglaterra};
        Sede[] sedes = {sede1, sede2, sede3, sede4, sede5, sede6, sede7, sede8, sede9, sede10, sede11};

        for (int i = 0; i < paisesConSede.length; i++) {
            paisesConSede[i].agregarSede(sedes[i]);
            mundial.agregarSede(sedes[i]);
        }
        ...
        Fase faseCuartos  = new Fase(); faseCuartos.setNombre(NombreFase.CUARTOS_DE_FINAL);
        Fase faseSemi     = new Fase(); faseSemi.setNombre(NombreFase.SEMIFINAL);
        Fase faseTercero  = new Fase(); faseTercero.setNombre(NombreFase.TERCER_PUESTO);
        ...
        // Polonia no tiene sede pero necesitamos el pais para el arbitro
        Pais polonia = new Pais("Polonia", "pol", null);
        ...
        Seleccion selArg = new Seleccion("AFA", "argkit", "argalt", true, 1, grupoA, argentina);
        selArg.agregarDirectoresTecnicos(dt_arg);
        argentina.setSeleccion(selArg);
        grupoA.agregarSeleccion(selArg);

        CuerpoTecnico ct_arg1 = new CuerpoTecnico(); ct_arg1.setNombre("Pablo Aimar");     ct_arg1.setRol(Rol.AYUDANTECAMPO);
        CuerpoTecnico ct_arg2 = new CuerpoTecnico(); ct_arg2.setNombre("Luis Islas");      ct_arg2.setRol(Rol.ENTRENADORARQUEROS);
        CuerpoTecnico ct_arg3 = new CuerpoTecnico(); ct_arg3.setNombre("Ricardo Vacchi");  ct_arg3.setRol(Rol.PREPARADORFISICO);
        ...
        Jugador martinez2 = new Jugador("Emiliano Martinez",  19920902,  1, null, 0, 0, null);

        for (Jugador j : new Jugador[]{messi, diMaria, martinez, romero, dybala, depaul, molina, martinez2})
        ...
        CuerpoTecnico ct_bra1 = new CuerpoTecnico(); ct_bra1.setNombre("Davide Ancelotti"); ct_bra1.setRol(Rol.AYUDANTECAMPO);
        CuerpoTecnico ct_bra2 = new CuerpoTecnico(); ct_bra2.setNombre("Taffarel");         ct_bra2.setRol(Rol.ENTRENADORARQUEROS);
        ...
        Jugador paqueta  = new Jugador("Lucas Paqueta",    19970827, 10, null, 0, 0, null);
        ...
        Seleccion selMex = new Seleccion("FMF", "mexkit", "mexalt", false, 15, grupoA, mexico);
        ...
        Seleccion selSen = new Seleccion("FSF", "senkit", "senalt", false, 20, grupoA, senegal);
        ...
        Seleccion selFra = new Seleccion("FFF", "frakit", "fraalt", true, 2, grupoB, francia);
        selFra.agregarDirectoresTecnicos(dt_fra);
        francia.setSeleccion(selFra);
        grupoB.agregarSeleccion(selFra);

        CuerpoTecnico ct_fra1 = new CuerpoTecnico(); ct_fra1.setNombre("Guy Stephan");    ct_fra1.setRol(Rol.AYUDANTECAMPO);
        CuerpoTecnico ct_fra2 = new CuerpoTecnico(); ct_fra2.setNombre("Franck Raviot");  ct_fra2.setRol(Rol.ENTRENADORARQUEROS);
        ...
        Seleccion selPor = new Seleccion("FPF", "porkit", "poralt", false, 6, grupoB, portugal);
        ...
        Seleccion selMar = new Seleccion("FRMF", "markit", "maralt", false, 13, grupoB, marruecos);
        ...
        Seleccion selEsp = new Seleccion("RFEF", "espkit", "espalt", true, 3, grupoC, espania);
        selEsp.agregarDirectoresTecnicos(dt_esp);
        espania.setSeleccion(selEsp);
        grupoC.agregarSeleccion(selEsp);

        CuerpoTecnico ct_esp1 = new CuerpoTecnico(); ct_esp1.setNombre("Mikel Etxarri");  ct_esp1.setRol(Rol.AYUDANTECAMPO);
        CuerpoTecnico ct_esp2 = new CuerpoTecnico(); ct_esp2.setNombre("Jose Manzanera"); ct_esp2.setRol(Rol.ENTRENADORARQUEROS);
        CuerpoTecnico ct_esp3 = new CuerpoTecnico(); ct_esp3.setNombre("Rafael Pol");     ct_esp3.setRol(Rol.PREPARADORFISICO);
        ...
        Seleccion selIta = new Seleccion("FIGC", "itakit", "itaalt", false, 9, grupoC, italia);
        ...
        Seleccion selCro = new Seleccion("HNS", "crokit", "croalt", false, 10, grupoC, croatia);
        ...
        Seleccion selJpn = new Seleccion("JFA", "jpnkit", "jpnalt", false, 18, grupoC, japon);
        ...
        Seleccion selEng = new Seleccion("FA", "engkit", "engalt", true, 5, grupoD, inglaterra);
        selEng.agregarDirectoresTecnicos(dt_eng);
        inglaterra.setSeleccion(selEng);
        grupoD.agregarSeleccion(selEng);

        CuerpoTecnico ct_eng1 = new CuerpoTecnico(); ct_eng1.setNombre("Steve Holland");  ct_eng1.setRol(Rol.AYUDANTECAMPO);
        CuerpoTecnico ct_eng2 = new CuerpoTecnico(); ct_eng2.setNombre("Martyn Margetson"); ct_eng2.setRol(Rol.ENTRENADORARQUEROS);
        ...
        Seleccion selNed = new Seleccion("KNVB", "nedkit", "nedalt", false, 7, grupoD, holanda);
        ...
        Seleccion selCol = new Seleccion("FCF", "colkit", "colalt", false, 12, grupoD, colombia);
        ...
        Jugador arias    = new Jugador("Daniel Munoz",     19960120,  2, null, 0, 0, null);
        Jugador ospina   = new Jugador("David Ospina",     19880831,  1, null, 0, 0, null);

        for (Jugador j : new Jugador[]{james, cuadrado, falcao, arias, ospina})
            registrarJugador(ad, selCol, j);

        // --- URUGUAY ---
        DirectoresTecnicos dt_uru = new DirectoresTecnicos("Marcelo Bielsa", 19550725, 20230101);
        Seleccion selUru = new Seleccion("AUF", "urukit", "urualt", false, 6, grupoD, uruguay);
        ...
        Jugador araujoo   = new Jugador("Ronald Araujo",        19990307,  4, null, 0, 0, null);
        Jugador nunez     = new Jugador("Darwin Nunez",         19990624, 11, null, 0, 0, null);

        for (Jugador j : new Jugador[]{suarez, cavani, valverde, bentancur, araujoo, nunez})
        ...
        estadio1.agregarPartido(gA1); faseGrupos.agregarPartido(gA1);
        ...
        selArg.agregarParticipacion(gA1L); selBra.agregarParticipacion(gA1V);
        ...
        estadio8.agregarPartido(gA2); faseGrupos.agregarPartido(gA2);
        ...
        selMex.agregarParticipacion(gA2L); selSen.agregarParticipacion(gA2V);
        ...
        estadio1.agregarPartido(gA3); faseGrupos.agregarPartido(gA3);
        ...
        selArg.agregarParticipacion(gA3L); selMex.agregarParticipacion(gA3V);
        ...
        estadio2.agregarPartido(gA4); faseGrupos.agregarPartido(gA4);
        ...
        selBra.agregarParticipacion(gA4L); selSen.agregarParticipacion(gA4V);
        ...
        estadio1.agregarPartido(gA5); faseGrupos.agregarPartido(gA5);
        ...
        selArg.agregarParticipacion(gA5L); selSen.agregarParticipacion(gA5V);
        ...
        estadio2.agregarPartido(gA6); faseGrupos.agregarPartido(gA6);
        ...
        selBra.agregarParticipacion(gA6L); selMex.agregarParticipacion(gA6V);
        ...
        estadio5.agregarPartido(gB1); faseGrupos.agregarPartido(gB1);
        ...
        selFra.agregarParticipacion(gB1L); selAle.agregarParticipacion(gB1V);
        ...
        estadio9.agregarPartido(gB2); faseGrupos.agregarPartido(gB2);
        ...
        selPor.agregarParticipacion(gB2L); selMar.agregarParticipacion(gB2V);
        ...
        estadio5.agregarPartido(gB3); faseGrupos.agregarPartido(gB3);
        ...
        selFra.agregarParticipacion(gB3L); selPor.agregarParticipacion(gB3V);
        ...
        estadio6.agregarPartido(gB4); faseGrupos.agregarPartido(gB4);
        ...
        selAle.agregarParticipacion(gB4L); selMar.agregarParticipacion(gB4V);
        ...
        estadio5.agregarPartido(gB5); faseGrupos.agregarPartido(gB5);
        ...
        selFra.agregarParticipacion(gB5L); selMar.agregarParticipacion(gB5V);
        ...
        estadio9.agregarPartido(gB6); faseGrupos.agregarPartido(gB6);
        ...
        selPor.agregarParticipacion(gB6L); selAle.agregarParticipacion(gB6V);
        ...
        estadio7.agregarPartido(gC1); faseGrupos.agregarPartido(gC1);
        ...
        selEsp.agregarParticipacion(gC1L); selIta.agregarParticipacion(gC1V);
        ...
        Partido gC2 = new Partido(20260617, 1800, 0, 0, estadio10, faseGrupos);
        estadio10.agregarPartido(gC2); faseGrupos.agregarPartido(gC2);
        ...
        selCro.agregarParticipacion(gC2L); selJpn.agregarParticipacion(gC2V);
        ...
        estadio7.agregarPartido(gC3); faseGrupos.agregarPartido(gC3);
        ...
        selEsp.agregarParticipacion(gC3L); selCro.agregarParticipacion(gC3V);
        ...
        estadio10.agregarPartido(gC4); faseGrupos.agregarPartido(gC4);
        ...
        selIta.agregarParticipacion(gC4L); selJpn.agregarParticipacion(gC4V);
        ...
        estadio7.agregarPartido(gC5); faseGrupos.agregarPartido(gC5);
        ...
        selEsp.agregarParticipacion(gC5L); selJpn.agregarParticipacion(gC5V);
        ...
        // ITA vs CRO — Empate 0-0, Italia avanza
        ...
        selIta.agregarParticipacion(gC6L); selCro.agregarParticipacion(gC6V);
        ...
        estadio11.agregarPartido(gD1); faseGrupos.agregarPartido(gD1);
        ...
        selEng.agregarParticipacion(gD1L); selNed.agregarParticipacion(gD1V);
        ...
        estadio4.agregarPartido(gD2); faseGrupos.agregarPartido(gD2);
        ...
        selCol.agregarParticipacion(gD2L); selUru.agregarParticipacion(gD2V);
        ...
        estadio11.agregarPartido(gD3); faseGrupos.agregarPartido(gD3);
        ...
        Partido gD4 = new Partido(20260622, 1800, 0, 0, estadio3, faseGrupos);
        estadio3.agregarPartido(gD4); faseGrupos.agregarPartido(gD4);
        ...
        selNed.agregarParticipacion(gD4L); selUru.agregarParticipacion(gD4V);
        ...
        estadio11.agregarPartido(gD5); faseGrupos.agregarPartido(gD5);
        ...
        selEng.agregarParticipacion(gD5L); selUru.agregarParticipacion(gD5V);
        gD5.asignarParticipacionesSinExcepcion(gD5L, gD5V);
        agregarEvento(gD5, rice,    TipoEvento.GOL,              63);
        agregarEvento(gD5, araujoo, TipoEvento.TARJETA_AMARILLA, 55);

        // NED vs COL — Holanda gana 2-0
        Partido gD6 = new Partido(20260626, 2000, 0, 0, estadio4, faseGrupos);
        estadio4.agregarPartido(gD6); faseGrupos.agregarPartido(gD6);
        ...
        selNed.agregarParticipacion(gD6L); selCol.agregarParticipacion(gD6V);
        ...
        // OCT1: ARG vs POR — Argentina gana 2-1
        Partido oct1 = new Partido(20260629, 2000, 0, 0, estadio1, faseOctavos);
        estadio1.agregarPartido(oct1); faseOctavos.agregarPartido(oct1);
        ...
        // OCT2: FRA vs BRA — Francia gana 1-0
        Partido oct2 = new Partido(20260630, 2000, 0, 0, estadio5, faseOctavos);
        estadio5.agregarPartido(oct2); faseOctavos.agregarPartido(oct2);
        ...
        selFra.agregarParticipacion(oct2L); selBra.agregarParticipacion(oct2V);
        ...
        // OCT3: ESP vs NED — España gana 2-0
        Partido oct3 = new Partido(20260701, 2000, 0, 0, estadio7, faseOctavos);
        estadio7.agregarPartido(oct3); faseOctavos.agregarPartido(oct3);
        ...
        selEsp.agregarParticipacion(oct3L); selNed.agregarParticipacion(oct3V);
        ...
        // OCT4: ENG vs ITA — Inglaterra gana 2-1
        Partido oct4 = new Partido(20260702, 2000, 0, 0, estadio11, faseOctavos);
        estadio11.agregarPartido(oct4); faseOctavos.agregarPartido(oct4);
        ...
        selEng.agregarParticipacion(oct4L); selIta.agregarParticipacion(oct4V);
        ...
        // CUAR1: ARG vs FRA — Argentina gana 1-0
        Partido cuar1 = new Partido(20260705, 2000, 0, 0, estadio1, faseCuartos);
        estadio1.agregarPartido(cuar1); faseCuartos.agregarPartido(cuar1);
        ...
        selArg.agregarParticipacion(cuar1L); selFra.agregarParticipacion(cuar1V);
        ...
        // CUAR2: ESP vs ENG — España gana 2-1
        Partido cuar2 = new Partido(20260706, 2000, 0, 0, estadio7, faseCuartos);
        estadio7.agregarPartido(cuar2); faseCuartos.agregarPartido(cuar2);
        ...
        selEsp.agregarParticipacion(cuar2L); selEng.agregarParticipacion(cuar2V);
        ...
        selArg.agregarParticipacion(semi1L); selEsp.agregarParticipacion(semi1V);
        ...
        selFra.agregarParticipacion(terL); selEng.agregarParticipacion(terV);
        ...
        selArg.agregarParticipacion(finL); selEsp.agregarParticipacion(finV);
