...
public class Partido {
    ...
    // ASOCIACIONES
    private Participacion [] participaciones; // un array con solo dos participaciones (mejor una lista )
    ...
    public Partido(int fecha, int horario, int duracion, int tiempoAdicional, Estadio estadio, Fase fase,
            List<Arbitraje> arbitrajes, Participacion[] participaciones) {
        this.fecha = fecha;
